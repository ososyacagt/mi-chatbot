...
export async function createEscalation({
  ...
  try {
    ...
    console.log("[escalation] Escalación creada:", data);
    console.log("[escalation] Enviando push a:", adminEmail);
    ...
    if (adminEmail) {
      ...
      console.log('[escalation] Push result:', pushResult);
    }
...
export async function getEscalations(tenantId, status = null) {
  try {
    ...
    // Solo filtrar por tenant si se proporciona
    if (tenantId) {
...
export async function getActiveEscalation(tenantId, sessionId) {
  try {
    ...
    console.log("[escalation] Escalación activa:", data?.id || "ninguna");
    return data || null;
  } catch (err) {
    console.error("[escalation] Error getActiveEscalation:", err);
    return null;
  }
}
